          ...
          Container(
            ...
            child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  ...
                  fit: BoxFit.fitWidth,
                  imageUrl: mainScreenProvider.featuredResto[widget.index].url,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                      ...
                      Container(
                        ...
                        child: Center(
                          ...
                          text: TextSpan(children: [
                            ...
                            TextSpan(
                                text: mainScreenProvider.featuredResto[widget.index].price
                                    .toString(),
                                style: TextStyle(
                                    fontSize: 13,
                                    color: Colors.black,
                ...
                Text(
                  mainScreenProvider.featuredResto[widget.index].name,
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        mainScreenProvider.featuredResto[widget.index].rating,
                        style: TextStyle(
                            fontSize: 12,
                            color: Colors.white,
                            fontWeight: FontWeight.bold),
...
class _CartItemState extends State<CartItem> {
  ...
  Widget build(BuildContext context) {
    ...
    FeatureProvider featureProvider =
        Provider.of<FeatureProvider>(context, listen: false);
    MainScreenProvider instance =
        Provider.of<MainScreenProvider>(context, listen: false);
    String id = instance.featuredResto[widget.index].id;
              ...
              ? InkWell(
                  onTap: () {
                    cartProvider.firstTime(
                        widget.index,  instance.featuredResto[widget.index]);
                  },
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                    ...
                    InkWell(
                      onTap: () {
                        cartProvider.decrement(widget.index,
                            instance.featuredResto[widget.index].id);
                      },
                      child: Container(
                        width: 25,
                        height: 30,
