...
class CartProvider extends ChangeNotifier {
  ...
  Future placeOrder(User user, String uidResto) async {
    screenDisable = true;
    notifyListeners();
    int orderNumber;
    Map abc = {};
    ...
    if (sucess) {
      ...
      _firestore.collection('restaurants').doc(uidResto.trim()).update({
        'orders': FieldValue.arrayUnion([orderNumber.toString()])
      });
