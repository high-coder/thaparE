...
class TopContainer implements SliverPersistentHeaderDelegate {
  ...
  TopContainer({this.minExtent, this.maxExtent,this.restoData,this.assetImage,this.showMenuIcon});
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                          fit: BoxFit.fitWidth,
                        image:assetImage == true? AssetImage('assets/images/bgmain2.jpg') : CachedNetworkImage(imageUrl: restoData.images[0])),
                    color: Colors.green,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    showMenuIcon == true ? InkWell(onTap: (){
            ...
            child: Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    // colors: [
                    //   Color(0xff476BB5).withOpacity(1.0),
                    //   Color(0xff73BCF8).withOpacity(0.3),
                    //   //Color(0xff476BB5),
                    //   //Color(0xffF86B6C),
                    //   Color(0xff0BB27E).withOpacity(0.7)
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        ...List.generate(restoData.tags.length, (index) {
                          return Tags(name: restoData.tags[index],);
                        }),
                        // Tags(
                        //   name: 'Meal',
                        // ),
